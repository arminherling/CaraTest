...
DiffHighlighter::DiffHighlighter(AalTest::DiffChange diffChange, const QColor& color, QTextDocument* parent)
...
void DiffHighlighter::highlightDiffs(const QList<AalTest::DiffLocation>& differences)
{
